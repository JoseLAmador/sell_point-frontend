                ...
                <div className={"first-section-two-products"} >
                    {
                        data.map((data, index)=>{
                            ...
                            return <CardAddProduct data={data} key={index} addItemCart={this.props.cartActions.addToCart} item={cartItem} />
                        })
                    }
...
ListProducts = connect(mapStateToProps, mapDispatchToProps)(ListProducts);
